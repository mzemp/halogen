...
void write_tipsy_xdr_halogen(FILE (*), const GI (*), const PARTICLE (*), const SI (*), const SI (*));
void write_tipsy_xdr_dpp_halogen(FILE (*), const GI (*), const PARTICLE (*), const SI (*), const SI (*));
